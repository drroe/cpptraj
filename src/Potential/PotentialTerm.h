...
class PotentialTerm {
  public:
    // NOTE: New types should update typeStr_ as well
    enum Type { BOND = 0, ANGLE, DIHEDRAL, SIMPLE_LJ_Q, OPENMM, REPLICATE, NTERMS };
    ...
    virtual void CalcEnergy(Frame const&, CharMask const&) const {}
